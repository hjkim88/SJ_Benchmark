...
#
#   Instruction
#               1. Source("Subread_bulk_rnaseq_AMD.R")
...
#
#   Example
#               > source("The_directory_of_Subread_bulk_rnaseq_AMD.R/Subread_bulk_rnaseq_AMD.R")
...
benchmark <- function(fastqgzPath1="/home/hkim8/SJ_Benchmark/data/FASTQ/ER_low_3_S9_R1.fastq.gz",
  ...
  write.table(results, file = paste0(outputDir, "benchmark_subread_amd.txt"), sep = "\t")
